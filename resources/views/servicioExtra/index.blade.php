...
@section('titulo','Gestión de Servicios Extras')
...
<div class="header-section">
  ...
  <div class="right-buttons">
    <button type="button" class="btn yellow" id="btnExportarPdf" data-ruta-pdf="{{ route('pdf.servicio_extra') }}">📄 PDF</button>
...
<table>
  ...
  <tbody>
    ...
    <tr data-id="{{ $dato['id'] }}"
        data-filtro-texto="{{ strtolower($dato['nombre'].' '.$dato['descripcion']) }}"
        ...
        <td class="acciones">
            ...
            <button type="button" class="btn btn-pdf" data-ruta-pdf="{{ route('pdf.servicio_extra') }}" data-id="{{ $dato['id'] }}">PDF</button>
